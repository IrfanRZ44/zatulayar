...
public class SubBidang {
     ...
     */
    public SubBidang(Integer idSubBidang, String idAdmin, Integer idBidang, String nama, Integer isActive, String deskripsiSingkat, String createdAt, String updatedAt) {
        super();
